...
""",
    ...
    "description_hy": """
<h3>Ակնարկ</h3>
<p>Սևանա լիճը գտնվում է ծովի մակերևույթից մոտ 1900 մ բարձրության վրա և աշխարհի ամենամեծ բարձրադիր քաղցրահամ լճերից է՝ մոտ 1242 կմ² մակերեսով։ Ամռանը վերածվում է լողի, ջրային սպորտի ու ձկնորսության կենտրոնի։</p>
...
""",
    ...
    "description_hy": """
<h3>Բնություն</h3>
<p>Պարզ լիճը գտնվում է մոտ 1330 մ բարձրության վրա՝ Դիլիջանի ազգային պարկի անտառների մեջ։ Լճի շուրջ կա մոտ 2 կմ թեթև արշավային երթուղի, հարմար ընտանիքի համար։</p>
...
<h3>Ինչպես հասնել</h3>
<p>Դիլիջան քաղաքից մոտ 7 կմ՝ տաքսիով կամ մեքենայով անտառային ճանապարհով, որը ցուցանշված է Պարզ լճի ուղղությամբ։</p>
""",
    "description_en": """
<h3>Nature</h3>
...
<h3>What to Do</h3>
<p>Take forest walks, follow the trail towards Goshavank, photograph the mirror-like lake surface, watch birds and relax at the outdoor cafes and picnic areas.</p>
<h3>How to Get There</h3>
...
<p>Ազատ գետն անհամար տարիների ընթացքում փորել է Գառնու կիրճը, որի պատերին կան 40–50 մ բարձրության վեցանկյուն բազալտե սյուներ՝ հայտնի որպես «Քարերի սիմֆոնիա» կամ Basalt Organ։ Դրանք ձևավորվել են հնագույն հրաբխային ակտիվության և դանդաղ սառեցման արդյունքում։</p>
...
<p>Մոտ 3–4 կմ քայլ, ասֆալտ ճանապարհ չկա, հարկ է հարմար կոշիկ հագնել։ Կիրճ մտնելուց հետո ուղղակի կանգ ես առնում ու երկար ժամ նայում սյուներին։</p>
""",
    "description_en": """
...
<h3>Ինչպես հասնել</h3>
<p>Հասանելի է մեքենայով Ապարանից կամ Բյուրականից՝ ոլոռնապատ, բայց ամբողջությամբ ասֆալտապատ լեռնային ճանապարհով մինչև ափ։</p>
""",
    "description_en": """
<h3>Nature</h3>
...
<p>Դիլիջանը հիանալի հենակետ է շրջակա տարածքի ուսումնասիրման համար՝ Հաղարծին, Գոշավանք, Պարզ լիճ, ազգային պարկի արահետներ։ Բայց նույնիսկ առանց քաղաքից դուրս գալու, Շարամբեյան ու պարկ անցկացրած մի օրը բավական է հասկանալու, թե ինչու Դիլիջանն անվանում են Հայաստանի փոքրիկ Շվեյցարիան։</p>
<h3>Ինչ անել</h3>
<p>Հին թաղամաս ու քաղաքային պարկ, Հաղարծին ու Գոշավանք վանքեր, Դիլիջանի ազգային պարկի արահետներ, Պարզ լիճ, արհեստանոցներ Շարամբեյանում։</p>
<h3>Ինչպես հասնել</h3>
...
<p>The heart of old Dilijan is Sharambeyan Street, lined with restored stone houses, traditional balconies, artisan workshops and cosy cafes where you can watch woodcarvers, potters and weavers at work.</p>
...
<p>Գյուղի երկու կողմերը հիմա կապված են երկար կախովի կամուրջով, ինչն ինքնին փոքրիկ արկած է։ Կանգնած կամուրջի մեջտեղում տեսնում ես ժայռերին ցրված քարայրները և զգում, թե որքան դրամատիկ է լանդշաֆտն ըստ էության։</p>
<p>Քարայրների մի մասը հեշտ մատչելի է, և դեռ պահպանված են առօրյա կյանքի հետքեր՝ մրոտված առաստաղներ, պատերին փորված խորշեր, կիսավեր սենյակներ, որտեղ ընտանիքներ են եփել, քնել ու կենդանիներ պահել։</p>
...
<h3>Ինչպես հասնել</h3>
<p>Գորիս քաղաքից մոտ 8 կմ՝ տաքսիով կամ մեքենայով լեռնային ճանապարհով։</p>
""",
    "description_en": """
<h3>What Is It</h3>
...
""",
    ...
    "short_hy": "7500-ամյա մեգալիթյան համալիր — աշխարհի ամենահին աստղադիտարաններից մեկը",
...
<h3>Ինչ անել</h3>
<p>Ամրոցի պարագծով զբոսանք, եկեղեցու այց, Արագածի ու Արարատի համայնապատկեր, Մեծ Աղբյուր ջրվեժ, Քարի լճի հետ համատեղ ուղևորություն։</p>
<h3>Ինչպես հասնել</h3>
...
""",
    ...
    "description_hy": """
<h3>Ինչ է սա</h3>
<p>Հին Խոտը գյուղ է, որ լքվել է 20-րդ դարի սկզբին՝ պահպանելով 19-րդ դարի կարմիր տուֆե տների մնացորդները Տաթև վանքի մոտ կիրճի արահետի երկայնքով։</p>
...
""",
    ...
    "short_hy": "Բնական քարե կամուրջ ու ձորի կապույտ-կանաչ լողավազաններ — Հայաստանի ամենավայրի վայրերից մեկը",
...
""",
    ...
    "short_hy": "Հայաստանի ամենամեծ լեռնային ճահճուտը և թռչունների դիտման դրախտ՝ Շիրակի մարզում",
...
""",
    ...
    "description_hy": """
<h3>Բնություն</h3>
<p>Գոշ լիճը Տավուշի մարզի անտառային լիճ է, որ հիմնականում դուրս է մնում զբոսաշրջային ուղիներից։ 12-րդ դարի Գոշավանք վանքը հենց մոտ է, ինչն ունի Տավուշ-այցի լավ համադրություն։</p>
...
<p>Լիճ հասնելու համար անտառային արահետով ես քայլում՝ փափուկ հող, արմատներ, ժայռեր, փոքր առուներ ու մամուռի կտորներ։ Պարզ լճի համեմատ, որ շատ հեշտ մատչելի է, Գոշ լիճն ավելի փոքրիկ արկած է՝ պետք է քայլել ու վաստակել, ու հենց դա է պահում մթնոլորտն անդորրով, երբ հասնում ես։</p>
<p>Եթե արդեն այցելել ես Պարզ լիճ ու ուզում ես Դիլիջանի ավելի վայրի կողմն ապրել, Գոշ լիճը հաջորդ տրամաբանական քայլն է։ Այն վայր է, ուր հեշտ է ժամանակի հետևից կորցնել, հատկապես եթե ափին հանգիստ նստես ու դիտես, թե ինչպես անտառն ինքն իրեն ջրի մակերեսին ներկում ու վերաներկում է։</p>
<h3>Ինչ անել</h3>
<p>Գոշավանք, ափային արահետ, արտացոլումների լուսանկարչություն, շրջակա անտառի ուսումնասիրություն, Դիլիջան ու Պարզ լճի հետ համատեղ ուղևորություն։</p>
<h3>Ինչպես հասնել</h3>
...
<p>Ջերմուկ այցն ամենալավն է համատեղել հանգստի ու բնության հետ՝ ժամանակ անցկացնել սպայում, ճաշակել հանքային ջուրը հանքային ջրի պատկերասրահում, հետո ջրվեժ իջնել ու զգալ դեմքիդ ու ձեռքերիդ վրա ծածկվող ցողը։</p>
<h3>Ինչ անել</h3>
...
<p>Ցերեկը կարելի է զբոսնել տարածքով, մոտից տեսնել տարբեր գմբեթները ու լսել այստեղ արված հայտնագործությունների պատմությունները։ Ուղեկցված այցերի ժամանակ երբեմն հնարավոր է ներս մտնել ու տեսնել աստղադիտակները, ու կազմակերպել աստղադիտում՝ կանխավ ամրագրելով։</p>
<p>Արագածի լանջին, Բյուրական գյուղի մոտ, Բյուրականը նման է փոքրիկ գիտական քաղաքի՝ ծառերի ու ցածր շինությունների մեջ ցրված աստղադիտակի գմբեթներ, բոլորը ձևավորված գիշերային երկնքի ուսումնասիրության համար։ Համբարձումյանն ու նրա թիմը կազմեցին կարևոր աստղային ու գալակտիկական կատալոգներ ու ողջ աշխարհից գիտնականներ ընդունեցին։</p>
...
<h3>Ինչ անել</h3>
<p>Ուղեկցված այց, աստղադիտակի դիտում (կանխավ ամրագրել), երեկոյան աստղադիտում, Ամբերդ բերդի հետ համատեղ ուղևորություն, Արագածի լանդշաֆտ։</p>
<h3>Ինչպես հասնել</h3>
...
""",
    ...
    "short_hy": "IV դ. հաստատված արգելոց՝ Հայաստանի ամենահինը, ալպյան արշավի ու վայրի բնության համար",
...
<p>If you have already seen Garni and want to push a bit deeper into Armenia's wild side without committing to a multi-day trek, the accessible trails of Khosrov are an ideal next step — fewer cars, more rock and silence, and a strong sense of being very far from the city.</p>
<h3>What to Do</h3>
<p>Guided hikes on permitted trails, gorge walks, wildlife spotting and alpine landscape photography.</p>
<h3>How to Get There</h3>
<p>About 40 km from Yerevan toward Garni. Entry is only with a licensed guide or official permit.</p>
""",
    },
    {
    "id": "zvartnots",
...
<p>Տեսնելու են նրբագեղ փորագրված կապիտելներ, ֆրիզ, հնագույն խճանկարի բեկորներ, շրջանաձև հատակագիծ ու մասամբ վերականգնված սյուներ, Արարատ լեռան համայնապատկերով ֆոնին։</p>
<p>Տեղամասի թանգարանը պահպանում է փորագրված տարրեր ու ճարտարապետական բեկորներ։ Ամենալավն է Էջմիածնի ու Հռիփսիմեի հետ նույն օրը այցելել։</p>
<h3>Ինչ անել</h3>
<p>Ավերակների ու սյուների ուսումնասիրություն, տեղամասի թանգարան, Արարատի ու Արագածի համայնապատկեր, Էջմիածնի հետ համատեղ ուղևորություն։</p>
<h3>Ինչպես հասնել</h3>
<p>Երևանից մոտ 20 կմ, Էջմիածնից մոտ 2 կմ։ Ավտոբուս դեպի Էջմիածին կամ մեքենայով։</p>
""",
    "description_en": """
<h3>History</h3>
...
<p>Կասկադի համալիրի ներսում Ճաֆէսճեանի թանգարանն է՝ բացօթյա ու ներքին ժամանակակից արվեստի թանգարան, հսկայական քանդակներով և տեռասների ու պատկերասրահների ներսում ցուցադրություններով։</p>
<p>Կասկադի ստորոտում Թամանյան հրապարակն է, ուր ժամանակակից քանդակները բաց երկնքի տակ տարածքը դարձրել են քաղաքի ամենասիրված հանդիպման կետերից մեկը։ Ստեղծագործական տնտեսության զարգացման հետ հրապարակի շուրջ հայտնվել են արտ-կաֆեներ, ռեստորաններ ու գալերեաներ, և ամբողջ համալիրն ավելի կենդանի ու բազմազան է դարձել։</p>
<p>Եթե Երևանում առաջին անգամ ես, Կասկադն ամենալավ վայրերից մեկն է սկսելու․ առավոտյան ավելի հանգիստ է ու կատարյալ ամբողջ ճանապարհը վեր բարձրանալու համար, իսկ երեկոյան աստիճաններին նստած մարդկանց, կենդանի երաժշտության և քաղաքի լույսերի համադրությունն արտացոլում է Երևանի ամենաեռանդուն կողմը։</p>
<h3>Ինչ անել</h3>
<p>Գագաթ բարձրանալ քաղաքի համայնապատկերի համար, այցելել Ճաֆէսճեանի թանգարան, ուսումնասիրել բացօթյա քանդակները, տեսնել Թամանյանի հուշարձանը, երեկոյան զբոսնել լուսավորված Երևանով։</p>
<h3>Ինչպես հասնել</h3>
<p>Քաղաքի կենտրոնում՝ Մոսկովյան 10 հասցեում։ Հեշտ հասանելի է ոտքով, տաքսիով կամ ավտոբուսով։</p>
""",
    "description_en": """
<h3>What Is It</h3>
...
<h3>How to Get There</h3>
<p>City centre at 53 Mashtots Avenue. 10 minutes on foot from Yeritasardakan metro station.</p>
""",
    },
]
