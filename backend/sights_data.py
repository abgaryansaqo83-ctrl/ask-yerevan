...
<p>Անունը կապված է «զվարт» բառի հետ, ինչը նշանակում է ուրախ կամ պայծառ, ու «զվարտաց»՝ երկնային զորքեր հասկացության հետ, ինչն անվանը տալիս է «հրեշտակների բնակարան» իմաստ։ Շրջանաձև հատակագծով, բաց սյունաշարերով ու վերևից ֆիլտրվող լույսով՝ տաճարը ձևավորվել էր որպես տարածք, ուր ճարտարապետությունն ու լույսը միասին են աշխատում։</p>
<p>Տեսնելու է նրբագեղ փորագրված կապիտելներ, ֆրիզ, հնագույն խճանկարի բեկորներ, շրջանաձև հատակագիծ ու մասամբ վերականգնված սյուներ՝ Արարատ լեռան համայնապատկերով ֆոնին։</p>
...
<h3>Ինչպես հասնել</h3>
<p>Երևանից 20 կմ, Էջմիածնից 2 կմ։ Ավտոբուս դեպի Էջմիածին կամ մեքենայով։</p>
""",
        "description_en": """
<h3>History</h3>
